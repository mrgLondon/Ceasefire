		...
		elseif ($field_property['field_type'] == 10) //my new custom Flexibledate field type
		{
			...
			else
			{
				...
				echo form::input('custom_field['.$field_id.']', $field_value, $id_name .' class="text custom_text"');
                        ...
                        echo "<h4>" . $field_property['field_name'] . $isrequired . " " . $isprivate . "</h4>";
                        //echo "<div class='report_row' id='datesec' >";
                        echo Kohana::lang('ui_main.day').": <select onchange='changeDate".$field_id."()' name='day".$field_id."' value='00'>Day<option value='00'>--</option> <option value='01'>1</option><option value='02'>2</option><option value='03'>3</option><option value='04'>4</option><option value='05'>5</option><option value='06'>6</option><option value='07'>7</option><option value='08'>8</option><option value='09'>9</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option><option value='24'>24</option><option value='25'>25</option><option value='26'>26</option><option value='27'>27</option><option value='28'>28</option><option value='29'>29</option><option value='30'>30</option><option value='31'>31</option></select>";
                        echo Kohana::lang('ui_main.month').": <select onchange='changeDate".$field_id."()' name='month".$field_id."' value='00'>Month<option value='00'>--</option>  <option value='01'>January</option><option value='02'>February</option><option value='03'>March</option><option value='04'>April</option><option value='05'>May</option><option value='06'>June</option><option value='07'>July</option><option value='08'>August</option><option value='09'>September</option><option value='10'>October</option><option value='11'>November</option><option value='12'>December</option></select>";
                        echo Kohana::lang('ui_main.year').": <select onchange='changeDate".$field_id."()' name='year".$field_id."' value='0000'>Year<option value='0000'>--</option>";
