...
/*
			...
			$("#select_gov").change(function() {
				...
				if ( lonlat[0] && lonlat[1] )
				{
					...
					$("#location_name").attr("value", $('#select_gov :selected').text());

					$("#latitude").attr("value", lonlat[1]);
					$("#longitude").attr("value", lonlat[0]);
				}
                                 
                                $('#select_city').find('option').each(function(index,element){
                               // $(document.getElementById('select_city').options).each(function(index, element) {
                                rec = element.value.split(",")
                                //alert(rec[0])

                                if (rec[0] == govID || element.value==""){
                                    //alert('yes');
                                    //element.hidden = new Boolean("true");
                                 ...
                                 $("#select_city").val("")
                                //$("#select_city").find('option[value="40.15,33.00"]').hide();
                                //$("#select_city").find('option[value="40.15,33.00"]').show();
